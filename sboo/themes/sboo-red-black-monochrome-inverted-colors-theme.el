;;; sboo-red-black-monochrome-inverted-colors-theme.el --- HighContrast InvertedColors.
...
(defvar inverted-white "Black"
  "The color « white » is inverted « black ».")
...
(custom-theme-set-faces
 ...
 `(default                                    ((t (:background ,inverted-black :foreground ,inverted-white))))

 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ;; Highlights

 `(region                                     ((t (:background ,inverted-white :foreground ,inverted-black :bold 1))))
 ...
 `(haskell-operator-face                    ((t (:foreground ,inverted-red :bold t))))
 `(haskell-type-face                        ((t (:foreground ,inverted-red))))
 `(haskell-constructor-face                 ((t (:foreground ,inverted-red))))
 `(haskell-keyword-face                     ((t (:foreground ,inverted-red))))
 `(haskell-definition-face                  ((t (:foreground ,inverted-red :underline nil))))

 ;; `(haskell-quasi-quote-face                 ((t (:foreground ""))))
 ;; `(haskell-hole-face                        ((t (:foreground ""))))

 ;; `(haskell-literate-comment-face            ((t (:foreground ""))))
 `(haskell-pragma-face                      ((t (:foreground ,inverted-red))))
 `(haskell-liquid-haskell-annotation-face   ((t (:foreground ,inverted-red))))
 ...
 `(font-lock-keyword-face                     ((t (:bold t              :foreground ,inverted-red))))
 `(font-lock-builtin-face                     ((t (:bold t              :foreground ,inverted-red))))
 `(font-lock-constant-face                    ((t (:bold t :underline t :foreground ,inverted-red))))
 `(font-lock-string-face                      ((t (:bold t              :foreground ,inverted-red :italic t))))
 ...
 `(font-lock-preprocessor-face                ((t (:bold t              :foreground ,inverted-red))))

;;TODO `(font-lock-error-face                       ((t (:bold t              :foreground ,inverted-red))))
 `(font-lock-warning-face                     ((t (:bold t              :foreground ,inverted-red))))
